...
public class WebParams {
    ...
    public static final String ATTRACTION_API = ALL_API + "attractions";
    public static final String ATTRACTION_PAGINATION = ALL_API + "attractions/";
    public static final String DESTINATION_API = ALL_API + "destinations";
    ...
    public static final String ATTRACTION_ADD = ATTRACTION_API + ALL_API + "add";
    public static final String DESTINATION_ADD = DESTINATION_API + ALL_API + "add";
